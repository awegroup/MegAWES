...
>[!IMPORTANT]
>This branch uses an alternative control architecture using optimal torque control and kite tether force control, see [this README](README_DevTetherForceControl.md) for more information.
