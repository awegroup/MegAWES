...
% :param v_w_vec: Kite velocity in wind reference frame.
% :param pos_W: Position of the kite in wind reference frame.
% :param p_C_W: Closest position on Lissajous figure.
% :param t: Tangent at p_C_W.
% :param DtDs: Derivative of the tangent with respect to the position on the Lissajous figure.
% :param chi_parallel: Required course angle to reach p_C_W.
% :returns: 
